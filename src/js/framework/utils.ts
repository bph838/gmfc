...
export function initMapFrame(data: {
  ...
  mapDiv.innerHTML = `<iframe
    ...
    src="https://www.google.com/maps?q=${latitude},${longitude}&t=${display}&hl=en&z=${zoom}&output=embed">
  </iframe>`;
}
...
export function formatLaptime(secs: number) {
...
export function getDayOfYearUTC(input: string | number | Date) {
...
export function isBritishSummerTime(date = new Date()) {
  ...
  function getLastSunday(month: number) {
